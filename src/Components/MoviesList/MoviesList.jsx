...
export default function MoviesList() {
  return (
    <>
      <div className="offset-1 col-md-4 col-6 px-0 py-2" style={{ backgroundColor: "#24292c",borderRadius: "10px" }}>


        <div
          className="card d-flex justify-content-start align-items-start "
          style={{border: "none",borderRadius: "0px", backgroundColor: "transparent",borderBottom: "1px solid #353535" }}
        >
